...
<div class="dropdown"> <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false"> <img src="img/perfilusuario.png" alt="" width="32" height="32" class="rounded-circle me-2"> <strong>&nbsp <?php echo  $_SESSION["tipo_usuario"];?>  </strong> </a>
...
<hr>
    ...
    <ul class="nav nav-pills flex-column mb-auto" >
        ...
        <li> <a href="verzoousu.php" class="nav-link text-white"> <i class="fas fa-paw"></i>&nbsp<span class="ms-2">Zoologicos</span> </a> </li>
        <li> <a href="verespusu.php" class="nav-link text-white"> <i class="fas fa-feather-alt">&nbsp</i><span class="ms-2">Especies</span> </a> </li>
		<li> <a href="veraniusu.php" class="nav-link text-white"> <i class="fas fa-otter"></i>&nbsp<span class="ms-2">Animales</span> </a> </li>
		</ul>
    <hr>
