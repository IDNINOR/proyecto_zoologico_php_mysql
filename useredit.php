  ...
  if ($_POST['pass'] != $_POST['confirm'])
  {
   ...
   Swal.fire({
    ...
    icon : 'error',
        ...
        if(result.value){
          window.location='useredit.php?id=$id2';
        }
   });
   </script>";
    ...
    $emp->editaruser($_POST['pass'],$_POST['newid2'],$_POST['respuesta1'],$_POST['respuesta2']);
    exit();
...
<div class="card-body">
           ...
           <div>
               <form name="form" action="useredit.php" method="post">
